...
func zyColorGray(_ num : CGFloat, _ alpha : CGFloat = 1.0) -> UIColor {
    return UIColor(red: num/255.0, green: num/255.0, blue: num/255.0, alpha: alpha)
}

/** 根据rgb获取一个UIColor */
func zyColorRGB(_ r : CGFloat, _ g : CGFloat, _ b : CGFloat, _ alpha : CGFloat = 1.0) -> UIColor {
    return UIColor(red: r/255.0, green: g/255.0, blue: b/255.0, alpha: alpha)
}

/** 获取一个随机色 */
public var zyColorRandom : UIColor {
